...
const TormsSideBar = () => {
    return (
        <>
            <aside className="w-[8%] bg-black min-h-screen flex flex-col items-center pt-5 pb-14">
                ...
                <div className="flex flex-col justify-between flex-1 w-full">
                    <nav className="mt-16">
                        <ul className="text-white flex flex-col items-center space-y-12">
                            <li className="w-full flex justify-center hover:text-green-600 hover:border-l-4 hover:border-green-600 transition-all ease-in-out">
                            ...
                            <li className="w-full flex justify-center hover:text-green-600 hover:border-l-4 hover:border-green-600 transition-all ease-in-out">
                                <MdStackedLineChart className="w-7 h-10"/></li>
                            <li className="flex items-center w-full justify-center hover:text-green-600 hover:border-l-4 hover:border-green-600 transition-all ease-in-out">
